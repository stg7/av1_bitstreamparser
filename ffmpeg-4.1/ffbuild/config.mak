...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--pkg-config-flags=--static --disable-doc --enable-pthreads --enable-debug=2 --disable-nvenc --disable-libx265 --enable-libaom --enable-decoder=libaom_av1 --enable-parser=av1 --enable-demuxer=matroska --extra-ldflags=-L/home/stg7/av1_bitstreamparser/ffmpeg-4.1/../libaom/lib --disable-vaapi --enable-gpl
prefix=/usr/local
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS= -L/home/stg7/av1_bitstreamparser/ffmpeg-4.1/../libaom/lib  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
...
EXTRALIBS-avcodec=-pthread -lm -llzma -lz -L/home/stg7/av1_bitstreamparser/libaom/lib -laom -lm -lpthread
